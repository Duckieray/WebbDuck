...
| `tests/test_krea2_identity_runtime.py` | Krea identity worker payload/dispatch, resident-block VRAM budgeting, persona presets, and effective→requested artifact upscale (ESRGAN + LANCZOS fallback) |
