...
| `tests/test_krea2_identity.py` | Krea identity adapter contract, markup controls, paired-block forward, and perf-env overrides |
| `tests/test_krea2_identity_runtime.py` | Krea identity worker payload/dispatch and persona presets |
