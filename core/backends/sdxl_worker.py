...
and opts into the backend-owned pipeline through the lightweight core.pipeline
facade before importing the mature SDXL runtime.
"""
...
# core.pipeline is a lightweight host facade unless this flag is present.
